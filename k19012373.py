...
# Imports
from networkx import Graph, get_node_attributes, diameter, check_planarity, voronoi_cells, cycle_basis, path_weight, shortest_path_length, shortest_path
...
class Main:
    ...
    def print_map(self):
        ...
        print("Close the map to continue.")
        plt.show()
